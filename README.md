...
Here you can find an example of the api/measure/search 
File: [sonarqube_measure_search.py](sonarqube_measure_search.py)
...
How to execute the code:
```sh
python sonarqube_measure_search.py
```

## Sonarqube measures by project
Here you can find an example more complex using two api api/project/search and api/measure/component 
File: [sonarqube_measures_by_project.py](sonarqube_measures_by_project.py)
...
How to execute the code:
```sh
python sonarqube_measures_by_project.py)
```
